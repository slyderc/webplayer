...
$jsShareManagerVersion = filemtime(__DIR__ . '/js/managers/share-manager.js');
...
<head>
    ...
    <script src="./js/managers/share-manager.js?v=<?php echo $jsShareManagerVersion; ?>"></script>
            ...
            <div class="player-bar-content">
                ...
                <div class="controls">
                    <button class="love-button" id="loveButton" data-loved="false">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="heart-icon">
                            <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78L12 21.23l8.84-8.84a5.5 5.5 0 0 0 0-7.78z"/>
                        </svg>
                    </button>
                    <button class="share-button" id="shareButton">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="share-icon">
